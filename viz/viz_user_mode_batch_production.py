...
if entire_search_page_range == []:
    ...
    to_be_highlighted_pages = get_edited_pages(showed_pages, st.session_state["format_ocr_result"], extract_blocks,
                                               None, place, eval_term, selected_state)
    ...
    edited_pages = get_edited_pages(showed_pages, st.session_state["format_ocr_result"], extract_blocks, llm_output,
                                    place, eval_term, selected_state)
